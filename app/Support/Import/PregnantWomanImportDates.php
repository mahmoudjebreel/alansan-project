 ...
 * because April has no 31st, and so does any cell holding something that is
 * not a date.
 *
 ...
 * doing this by shape: the alternative is not "no interpretation", it is
 * PHP's American default applied silently.
 *
 * Which columns may lose a cell rather than fail their row is decided in
 * DROPPABLE below, and only newborn_dob is on that list.
 */
