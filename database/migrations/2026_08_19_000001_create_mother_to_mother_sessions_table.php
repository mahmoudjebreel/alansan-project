...
return new class extends Migration
{
    ...
    {
        Schema::create('mother_to_mother_sessions', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('locality', ['mosaab_camp', 'el_salam_camp', 'mahabba_camp', 'el_qoqa']);
            ...
            $table->string('receives_supplementary')->nullable();
            $table->timestamps();
            $table->softDeletes();
    ...
    {
        Schema::dropIfExists('mother_to_mother_sessions');
    }
};
