...
return [
    ...
    'user_activity' => [
        ...
        'online_hint' => 'Users seen in the panel during the last :minutes minutes.',
        'approximate' => 'Active time is approximate: only the seconds a visible tab reported are counted.',
        'columns' => [
            'user' => 'User',
            'status' => 'Status',
        ...
        'actions' => [
            'show_visits' => 'Page visits',
            'prune' => 'Prune telemetry',
            'prune_heading' => 'Delete old telemetry?',
            'prune_description' => 'Page visits and sessions older than :days days will be deleted. The Activity Log is not affected.',
            'prune_done' => 'Deleted :visits page visits and :sessions sessions.',
        ],
        'timeline' => [
            'heading' => 'User timeline',
            'hint' => 'Page visits and Activity Log entries for one user, newest first.',
            'user' => 'User',
            'select_user' => 'Choose a user to see their timeline.',
            'from' => 'From',
            'until' => 'Until',
            'event' => 'Event',
            'changed_fields' => 'Changed fields',
            'no_events' => 'Nothing recorded for this user in the chosen period.',
        ],
        'empty' => [
            'online' => 'Nobody is online right now.',
            'sessions' => 'No sessions recorded yet.',
            'visits' => 'No page visits recorded yet.',
        ],
        'duration' => [
            'seconds' => ':count s',
            'minutes' => ':count min',
