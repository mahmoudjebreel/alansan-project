...
return [
    ...
    'trash' => [
        ...
        'select_page' => 'تحديد الكل',
        'select_row' => 'تحديد السجل',
        'selected_count' => 'تم تحديد :count سجل',
        'select_everything' => 'تحديد كل السجلات في السلة (:count)',
        'everything_selected' => 'تم تحديد كل السجلات في السلة (:count)',
        'clear_selection' => 'إلغاء التحديد',
        'restore_selected' => 'استعادة المحدد',
        'force_delete_selected' => 'حذف المحدد نهائياً',
        'confirm_bulk_restore' => [
            'title' => 'استعادة السجلات المحددة',
            'text' => 'هل تريد استعادة :count سجل وإرجاعها إلى قوائمها الرئيسية؟',
            'confirm' => 'نعم، استعِد السجلات',
            'success' => 'تمت استعادة السجلات المحددة بنجاح',
            'error' => 'تعذّرت استعادة السجلات المحددة',
        ],
        'confirm_bulk_force_delete' => [
            'title' => 'حذف نهائي للسجلات المحددة',
            'text' => 'تحذير: سيتم حذف :count سجل نهائياً من قاعدة البيانات ولا يمكن استرجاعها مطلقاً. هل ترغب بالاستمرار؟',
            'confirm' => 'نعم، احذفها نهائياً',
            'success' => 'تم حذف السجلات المحددة نهائياً',
            'error' => 'تعذّر حذف السجلات المحددة',
        ],
    ...
    // -----------------------------------------------------------------
    // مركز الإحالة: مراجعة أطفال SAM/MAM بعد الاستيراد
    // -----------------------------------------------------------------
    // -----------------------------------------------------------------
    ...
    'follow_up_tabs' => [
        'all' => 'كل الحالات',
        'active' => 'متابعة نشطة',
        'closed' => 'مقفلة / مخرَّجة',
        'cured_pending_referral' => 'حالات شُفيت بانتظار الإحالة',
    ],
    ...
    // -----------------------------------------------------------------
    'cured_referral' => [
        'action' => 'إحالة إلى الأطفال',
        'heading' => 'إحالة إلى الأطفال: :name',
        'description' => 'هذا الطفل خُرِّج كحالة شفاء لكن لا يوجد له سجل في وحدة الأطفال بهذا رقم الهوية. سيُنشأ سجل في الأطفال من ملف المتابعة هذا. ملف المتابعة ونتيجته وزياراته لا تتغير.',
        'case' => 'ملف المتابعة',
        'outcome_line' => 'نتيجة المتابعة: :outcome (:date).',
        'unchanged_line' => 'سيبقى ملف المتابعة مقفلاً دون أي تغيير.',
        'submit' => 'تأكيد الإحالة',
        'done_title' => 'تمت الإحالة إلى الأطفال',
        'done_body' => 'أُنشئ سجل في الأطفال لـ :name. ملف المتابعة لم يتغير.',
        'blocked' => [
            'already_exists' => 'لم يُنشأ سجل: يوجد سجل في الأطفال بهذا رقم الهوية مسبقاً.',
            'not_cured' => 'لم يُنشأ سجل: ملف المتابعة هذا غير مقفل كحالة شفاء.',
            'missing_data' => 'لم يُنشأ سجل: بيانات الطفل الأساسية (الاسم أو رقم الهوية أو الجنس) ناقصة.',
            'no_visit' => 'لم يُنشأ سجل: لا توجد في ملف المتابعة زيارة محضورة يُؤخذ منها القياس.',
            'died' => 'لم يُنشأ سجل: هذا الطفل مسجَّل في المتابعة بنتيجة وفاة، وسيكون تاريخ السجل لاحقاً للوفاة.',
        ],
    ],
    ...
    'referral_center' => [
        'title' => 'مركز الإحالة',
        'nav' => 'مركز الإحالة',
        'description' => 'الأطفال الذين جاء قياسهم SAM أو MAM ولم يُفتح لهم ملف متابعة بعد. راجعهم ثم أحِل من ينبغي إدخاله إلى البرنامج.',
        'batch' => 'دفعة الاستيراد',
        'batch_label' => ':date · :count صف · :user',
        'all_batches' => 'كل الأطفال (غير محصور بدفعة واحدة)',
        'unknown_user' => 'غير معروف',
        'no_batch_notice' => 'لم تُسجَّل أي دفعة استيراد بعد، لذلك تُعرض هنا كل الحالات المؤهَّلة في السجل.',
        'summary' => [
            'total' => 'الإجمالي',
            'normal' => 'طبيعي',
            'mam' => 'MAM',
            'sam' => 'SAM',
            'unmeasured' => 'بدون قياس',
            'eligible' => 'مؤهَّل للإحالة',
        ],
        'columns' => [
            'classification' => 'SAM / MAM',
            'status' => 'حالة الإحالة',
            'follow_up_status' => 'حالة المتابعة الحالية',
            'age' => 'العمر',
        ],
        'status' => [
            'pending' => 'بانتظار المراجعة',
            'previously_followed' => 'مقفلة / سبقت متابعته',
            'in_follow_up' => 'موجود بالفعل في المتابعة',
            'needs_review' => 'تحتاج مراجعة (بدون قياس)',
            'died' => 'متوفى - لا يمكن تحويله',
            'missing_muac' => 'غير متوفر',
        ],
        'follow_up_status' => [
            'pending' => 'لم تتم متابعته من قبل',
            'previously_followed' => 'لديه ملف متابعة مقفل',
            'in_follow_up' => 'متابعة نشطة',
            'needs_review' => 'لم تتم متابعته من قبل',
            'died' => 'آخر ملف متابعة انتهى بنتيجة وفاة',
        ],
        'status_filter' => [
            'all' => 'كل الحالات المفحوصة (SAM و MAM وبدون قياس)',
            'eligible' => 'بانتظار القرار',
        ],
        'counters' => [
            'pending' => 'إحالات معلَّقة',
            'previously_followed' => 'مقفلة / سبقت متابعتها',
            'in_follow_up' => 'في المتابعة بالفعل',
            'needs_review' => 'بدون قياس MUAC',
            'died' => 'متوفون (لا يمكن تحويلهم)',
            'active_follow_ups' => 'متابعات نشطة',
            'closed_cases' => 'حالات مقفلة',
            'missing_follow_up_muac' => 'قياسات متابعة ناقصة',
        ],
        'refer_selected' => 'إحالة المحدَّدين',
        'confirm_heading' => 'تأكيد الإحالة',
        'confirm_body' => 'سيُفتح ملف متابعة وزيارة أولى لكل طفل محدَّد. لا تُنقل سجلات الأطفال ولا تتغيَّر.',
        'confirm_submit' => 'تأكيد الإحالة',
        'view_follow_up' => 'عرض سجل المتابعة',
        'referred' => 'تمت إحالة :count طفلاً إلى المتابعة.',
        'skipped' => 'تم تخطي :count (لديهم ملف متابعة مفتوح، أو لم يعد قياسهم SAM/MAM).',
        'skipped_active' => 'تم تجاهل :count لأن لديهم سجل متابعة نشط.',
        'skipped_closed' => 'تم تجاهل :count لأن لديهم سجل متابعة مقفل مسبقاً.',
        'skipped_died' => 'لا يمكن تحويل :count لأن آخر ملف متابعة لهم انتهى بنتيجة وفاة.',
        'skipped_ineligible' => 'تم تجاهل :count لأن قياسهم لم يعد SAM أو MAM.',
        'failed' => 'تعذَّرت إحالة :count وتُركوا لإعادة المحاولة.',
        'nothing_selected' => 'لم يتم تحديد أي طفل.',
        'empty_heading' => 'لا يوجد أطفال بانتظار الإحالة',
        'empty_description' => 'كل حالات SAM أو MAM في هذا النطاق لديها ملف متابعة بالفعل، مفتوح أو مقفل.',
    ],
    ...
    'referral' => [
        ...
        'readmission_title' => '⚠️ إعادة قبول: لهذا الطفل ملف متابعة مقفل',
        'previous_outcome' => 'نتيجة الملف السابق',
        ...
        'died_title' => '⛔ لا يمكن تسجيل هذا الطفل مرة أخرى',
        'died_ok' => 'حسناً',
    ],
    ...
    // -----------------------------------------------------------------
    'follow_up_identity' => [
        'known_from_follow_up' => 'معروف من ملف متابعة',
        'open' => 'ملف متابعة نشط',
        'closed' => 'ملف متابعة مقفل: :outcome (:date)',
    ],
    ...
    // -----------------------------------------------------------------
    'readmission' => [
        'heading' => 'إعادة قبول: :name',
        'description' => 'هذا الطفل موجود مسبقاً وملف متابعته السابق مقفل. سيُفتح ملف متابعة جديد كإعادة قبول يبدأ من الزيارة 1. الملف المقفل ونتيجته وزياراته لا تتغير.',
        'previous_case' => 'الملف السابق',
        'child_line' => 'الطفل: :name (هوية :id).',
        'outcome_line' => 'أُقفل الملف السابق بنتيجة: :outcome (:date).',
        'visits_line' => 'عدد الزيارات المسجلة في الملف السابق: :count.',
        'reading_line' => 'الفحص الحالي: مواك :muac مم (:fi).',
        'unchanged_line' => 'سيبقى الملف السابق مقفلاً دون أي تغيير.',
        'first_visit_date' => 'تاريخ الزيارة 1',
        'muac_hint' => 'القياس الذي يُعاد قبول الطفل عليه، ويصبح الزيارة 1 في الملف الجديد.',
        'muac_not_admissible' => 'البرنامج يقبل حالات SAM أو MAM فقط. هذا القياس طبيعي.',
        'submit' => 'تأكيد إعادة القبول',
        ...
        'reasons' => [
            ...
            'readmission_after_relapse' => 'أكمل الطفل سابقاً ملف SAM/MAM بنتيجة شُفي ثم عاد لاحقاً بحالة SAM/MAM.',
        ],
    ],

    'died_terminal' => [
        'message' => 'لا يمكن تسجيل الطفل مرة أخرى لأن آخر ملف متابعة له انتهى بنتيجة وفاة.',
        'follow_up_refused' => 'لم يُفتح ملف متابعة',
        'restore_refused_title' => 'لم يُسترجع',
        'restore_refused' => 'لا يمكن استرجاع ملف المتابعة هذا: تاريخه لاحق لملف متابعة الطفل الذي انتهى بنتيجة وفاة.',
        'restore_refused_count' => 'لم يُسترجع :count من ملفات المتابعة لأن تاريخها لاحق لملف متابعة الطفل الذي انتهى بنتيجة وفاة. بقيت في سلة المحذوفات.',
        'registration_refused' => 'رقم هوية هذا الطفل مسجَّل في المتابعة بنتيجة وفاة، ولا يمكن تسجيله كطفل مرة أخرى.',
        'child_restore_refused' => 'لا يمكن استرجاع سجل الأطفال هذا: تاريخه لاحق لملف متابعة الطفل الذي انتهى بنتيجة وفاة.',
        'child_restore_refused_count' => 'لم يُسترجع :count من سجلات الأطفال لأن تاريخها لاحق لملف متابعة الطفل الذي انتهى بنتيجة وفاة. بقيت في سلة المحذوفات.',
        'children_record_refused' => 'لم يُنشأ سجل في الأطفال',
    ],

    'follow_up_import' => [
        'died_in_file' => 'لا يمكن تسجيل الطفل :id مرة أخرى: صف آخر في هذا الملف يسجّل أن ملف متابعته انتهى بنتيجة وفاة، وهذا الصف بتاريخ لاحق لها.',
        'open_on_file' => 'للطفل :id ملف متابعة مفتوح. لا يمكن استيراد ملف متابعة جديد لهذا الطفل حتى يُغلق الملف المفتوح.',
        'open_in_file' => 'للطفل :id ملف متابعة مفتوح في صف آخر من هذا الملف. لا يمكن أن يكون للطفل إلا ملف مفتوح واحد، ولا يبدأ ملف في تاريخ ملف مفتوح أو بعده.',
    ],

    'csv_export' => [
        'failed_title' => 'لم يكتمل التصدير',
        'incomplete' => 'أُوقف التصدير لأنه لم يكتمل: المتوقع :expected صفاً وكُتب :written. لم يُرسل أي ملف. يرجى المحاولة مرة أخرى.',
        'corrupt' => 'تعذّرت قراءة طلب التصدير كاملاً. لم يُرسل أي ملف. يرجى التصدير مرة أخرى.',
        'unwritable' => 'تعذّرت كتابة ملف التصدير على الخادم. لم يُرسل أي ملف. يرجى المحاولة مرة أخرى.',
    ],
    ...
    'alerts' => [
        ...
        'duplicate_visit' => [
            ...
            'follow_up_state' => 'ملف المتابعة المسجل',
    ...
    'user_activity' => [
        ...
        'tabs' => [
            ...
            'sessions' => 'الجلسات',
            'visits' => 'زيارات الصفحات',
            'timeline' => 'الخط الزمني للمستخدم',
        ],
        'online_hint' => 'المستخدمون الذين ظهروا في اللوحة خلال آخر :minutes دقائق.',
        'approximate' => 'المدة النشطة تقريبية: تُحتسب فقط الثواني التي أبلغ عنها تبويب مرئي.',
        'columns' => [
            'user' => 'المستخدم',
            'status' => 'الحالة',
            ...
            'record' => 'السجل',
            'ip' => 'عنوان IP',
            'device' => 'المتصفح / الجهاز',
            'remember' => 'تذكرني',
            'login_at' => 'وقت الدخول',
            'last_seen_at' => 'آخر ظهور',
            'logout_at' => 'وقت الخروج',
            'visits' => 'الصفحات',
            'entered_at' => 'وقت الفتح',
            'ended_at' => 'وقت المغادرة',
        ...
        'filters' => [
            ...
            'session' => 'الجلسة رقم :id',
            'all_sessions' => 'عرض كل الجلسات',
        ],
        'actions' => [
            'show_visits' => 'زيارات الصفحات',
            'prune' => 'حذف البيانات القديمة',
            'prune_heading' => 'حذف بيانات التتبع القديمة؟',
            'prune_description' => 'سيتم حذف زيارات الصفحات والجلسات الأقدم من :days يوماً. سجل النشاطات لا يتأثر.',
            'prune_done' => 'تم حذف :visits زيارة و :sessions جلسة.',
        ],
        'timeline' => [
            'heading' => 'الخط الزمني للمستخدم',
            'hint' => 'زيارات الصفحات وسجل النشاطات لمستخدم واحد، الأحدث أولاً.',
            'user' => 'المستخدم',
            'select_user' => 'اختر مستخدماً لعرض خطه الزمني.',
            'from' => 'من',
            'until' => 'إلى',
            'event' => 'الحدث',
            'changed_fields' => 'الحقول المعدّلة',
            'no_events' => 'لا يوجد شيء مسجّل لهذا المستخدم في الفترة المحددة.',
        ],
        'empty' => [
            'online' => 'لا يوجد أحد متصل الآن.',
            'sessions' => 'لا توجد جلسات مسجّلة بعد.',
            'visits' => 'لا توجد زيارات مسجّلة بعد.',
        ],
        'duration' => [
            'seconds' => ':count ث',
            'minutes' => ':count د',
